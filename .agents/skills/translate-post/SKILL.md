...
한국어 파일 `content/ko/posts/<날짜>-<slug>/index.md`를 원문으로 사용합니다. 대상 언어는 영어, 일본어 또는 둘 다입니다. 원문과 `writing-style-guide.md` 전체를 읽습니다. 스타일 가이드는 한국어 원문의 품질 검토와 한국어 작업 보고에 적용하며 영어와 일본어 번역문에는 해당 언어의 자연스러운 기술 문체를 적용합니다.
