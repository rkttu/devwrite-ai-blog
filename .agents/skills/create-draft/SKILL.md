...
`scripts/new_post.py` 또는 현재 운영체제에 맞는 동등한 스크립트로 세 언어의 Page Bundle 뼈대를 만듭니다. 날짜는 기본적으로 Asia/Seoul 기준 현재 시각을 사용합니다. 사용자가 예약 일정을 지정하면 해당 공개 시각을 사용하며 초안 상태는 유지합니다.
