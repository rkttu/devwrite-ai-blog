...
- **원래 질문**: “런타임에 새로운 실행 코드를 생성하는지도 함께 설명해주세요.”라고 질문했습니다. 코드의 생성 여부를 묻습니다.

- **번역 오류 사례**: 번역기는 질문을 “Explain how to generate new executable code at runtime.”으로 옮겼습니다. 생성 여부를 묻던 질문이 생성 방법을 설명해 달라는 요청으로 바뀌었습니다.

- **정규화 후**: “런타임에 새로운 실행 코드를 생성합니까? 그 여부도 함께 설명해주세요.”로 문장을 바꿨습니다. 직접 의문문으로 생성 여부를 묻습니다.
