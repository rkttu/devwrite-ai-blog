...
| 区分 | 文 | 質問の意味 |
| --- | --- | --- |
| 元の質問 | 런타임에 새로운 실행 코드를 생성하는지도 함께 설명해주세요. | 生成するかどうか |
| 誤訳の例 | Explain how to generate new executable code at runtime. | 生成する方法 |
| 正規化後 | 런타임에 새로운 실행 코드를 생성합니까? 그 여부도 함께 설명해주세요. | 生成するかどうか |
