---
description: 포스트 본문을 분석해 SEO용 description 과 독자용 tldr 생성
argument-hint: <포스트 경로 또는 슬러그>
---

# Generate TL;DR and Description

> **스타일 가이드**: 작성 시 `writing-style-guide.md` 의 언어별 어투 규칙을 따르세요.
