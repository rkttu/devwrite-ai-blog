---
description: 수동으로 작성된 포스트에 프론트매터·TL;DR·히어로 이미지·번역을 보강
argument-hint: <content/ko/posts/.../index.md 경로>
---

# Complete Manual Post

> **스타일 가이드**: 글 작성 시 반드시 `writing-style-guide.md` 의 언어별 작성 규칙을 따르세요.
...
Follow translation guidelines from `/translate-post`:
