---
description: 발행 전 체크리스트로 포스트 품질·SEO·번역 일관성 검토
argument-hint: <slug 또는 파일 경로>
---

# Review Draft Post

> **스타일 가이드**: 검토 시 `writing-style-guide.md` 의 작성 규칙 준수 여부도 확인하세요.
