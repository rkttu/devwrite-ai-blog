---
description: 발행된 포스트를 모든 언어 버전 일괄 게시 취소 (draft false → true)
argument-hint: <slug>
---
...
### 변경된 파일
- ✅ content/ko/posts/{YYYY-MM-DD}-{slug}/index.md (draft: true)
- ✅ content/en/posts/{YYYY-MM-DD}-{slug}/index.md (draft: true)
- ✅ content/ja/posts/{YYYY-MM-DD}-{slug}/index.md (draft: true)
...
다시 발행하려면 `/publish-draft` 슬래시 커맨드를 사용하세요.
