...
# Create New Blog Post (Full Workflow)

> **스타일 가이드**: 글 작성 시 반드시 `writing-style-guide.md` 의 언어별 작성 규칙을 따르세요. (이미 `CLAUDE.md` 를 통해 컨텍스트에 로드되어 있습니다.)
...
- **Slug**: URL 에 쓸 영문 슬러그
- **Topic / Content**: 글의 주제, 개요, 또는 전체 본문
