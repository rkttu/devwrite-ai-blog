---
description: 한국어 포스트를 영어 또는 일본어로 번역 (Page Bundle 동일 디렉터리명 유지)
argument-hint: <slug> <en|ja>
---

# Translate Blog Post

> **스타일 가이드**: 번역 시 반드시 `writing-style-guide.md` 의 언어별 작성 규칙을 따르세요.
...
(슬러그와 대상 언어: `en` 또는 `ja`. 예: `dotnetpy-huggingface-from-csharp en`)
